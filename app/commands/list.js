...
const config = require("../config.json")//Mercy Code | Müzik Botu
...
.setColor('RANDOM')
.setDescription("**❗️ - Şu anda oynatma listesinde şarkı yok!**")//Mercy Code | Müzik Botu
.setTimestamp()
.setFooter(`${config.footer}`)
...
exports.conf = {
    enabled: true,//Mercy Code | Müzik Botu
    guildOnly: false,
