const Discord = require("discord.js");//Mercy Code | Müzik Botu
const client = new Discord.Client();
const config = require('./config.json');
const fs = require("fs");
const { Player } = require('discord-player');//Mercy Code | Müzik Botu
...
const log = message => {
  console.log(` ${message}`);//Mercy Code | Müzik Botu
};
require("./eventLoader.js")(client);
const player = new Player(client);
client.player = player;
client.commands = new Discord.Collection();
client.aliases = new Discord.Collection();//Mercy Code | Müzik Botu
